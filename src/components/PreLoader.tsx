        ...
        <div className={`flex items-center justify-center h-screen w-screen bg-black loading-page p-4 ${caesarDressing.className}`}>
            <div className="text-center space-y-6 animate-pulse max-w-md mx-auto">
                <svg
                    ...
                    className="mx-auto h-32 w-24 text-red-700 animate-spin-slow mb-5"
                    viewBox="0 0 512 512"
                >
                    <defs>
                        <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                            <stop offset="0%" style={{ stopColor: "#a80a0a", stopOpacity: 1 }} />
                            <stop offset="100%" style={{ stopColor: "#e80101", stopOpacity: 1 }} />
                        </linearGradient>
                    </defs>
                    <path
                        fill="#000000"
